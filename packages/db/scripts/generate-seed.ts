...
import { orderItemsTable, type InsertOrderItem } from "../src/schemas/orders";
...
const productsData: InsertProduct[] = [
  ...
  },
  {
    ...
    description: "Propaganda 3 - Both Days",
    price: 60_000,
    isActive: false,
    createdAt: now,
    updatedAt: now,
  ...
  // -- Ticket Bundle --
  {
    ...
    type: "ticket_bundle",
    name: "Bundling 1",
    description: "Main Event + 2 Day Pass Propa 3",
    price: 130_000,
    stock: 50,
    isActive: true,
    bundleItems: [
      { productId: "prod_tkt_main", type: "ticket" },
      { productId: "prod_tkt_p3d1d2", type: "ticket" },
    ],
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    type: "ticket_bundle",
    name: "Bundling 2",
    description: "Day 1 + Day 2 Propa 3",
    price: 60_000,
    stock: 60,
    isActive: true,
    bundleItems: [
  ...
  },
  {
    ...
    type: "ticket_bundle",
    name: "Bundling 3",
    description: "Main Event + Day 1 or Day 2 Propa 3",
    price: 100_000,
    stock: 50,
    isActive: true,
    bundleItems: [
  ...
  },
  {
    ...
    type: "ticket_bundle",
    name: "Bundling 4",
    description: "Main Event + Merch (topi/sticker/socks)",
    price: 95_000,
    stock: 40,
    isActive: true,
    bundleItems: [
