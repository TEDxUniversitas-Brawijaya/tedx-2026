...
export const NotFoundPage = () => {
  return (
    <>
      <Navbar />
      <main className="relative h-dvh overflow-hidden bg-black pt-18 md:pt-20">
        <div
          className="absolute inset-0 h-dvh w-dvw overflow-hidden"
          id="background-container"
        >
          <div className="h-dvh w-dvw bg-[oklch(0.371_0_0)] mix-blend-multiply" />
          <div
            className="mask-center mask-no-repeat mask-cover transform-[translate(-50%,-40%)] absolute top-1/2 left-1/2 h-[160dvh] w-dvw bg-[oklch(0.252_0_0)] opacity-20"
            style={{ maskImage: `url(${RedBrushStroke})` }}
          />
          <img
            alt=""
            className="pointer-events-none absolute inset-0 aspect-[1.78/1] h-dvh w-dvw object-cover mix-blend-multiply"
            height={713}
            src={PaperTexture1}
            width={1268}
          />
        ...
        <div
          className="md:transform-[translate(30%,0)] absolute top-[30%] left-1/2 h-[10dvh] w-auto translate-x-[20%] md:top-[40%] md:left-[18%] md:h-[20dvh] min-[425px]:h-[15dvh]"
          id="small-framed-art-1-container"
        >
          <img
            alt="Small Framed Art Overlay"
            className="filter-[brightness(0)_saturate(100%)] pointer-events-none absolute inset-0 z-2 aspect-[0.86/1] h-full w-auto object-contain opacity-40"
            height={218}
            src={SmallFramedArt1}
            width={217}
          />
          <img
            ...
            className="pointer-events-none relative aspect-[0.86/1] h-full w-auto object-contain"
            height={218}
            src={SmallFramedArt1}
            width={217}
          />
        ...
        <div
          className="md:transform-[translate(-90%,0)] absolute top-[35%] left-1/2 h-[12.5dvh] w-auto -translate-x-[90%] md:top-[50%] md:left-[29%] md:h-[25dvh] min-[425px]:h-[17.5dvh]"
        ...
        >
          <img
            alt="Hanging Lamp"
            className="pointer-events-none relative z-1 aspect-[0.6/1] h-[30dvh] w-auto object-contain"
            height={284}
            src={HangingLamp}
            width={171}
          />
          <svg
            aria-hidden="true"
            className="transform-[translate(-13%,-45.5%)] absolute top-full left-0 scale-[1.2] animate-blink"
            fill="none"
            focusable="false"
            height="112"
            viewBox="0 0 204 112"
          ...
          <svg
            aria-hidden="true"
            className="transform-[translate(-25%,-28%)] absolute top-full left-0 scale-[1.2] animate-blink opacity-100 transition-opacity duration-300"
            fill="none"
            focusable="false"
            height="299"
            viewBox="0 0 394 299"
        ...
        <div
          className="absolute top-0 right-1/2 translate-x-1/2 md:top-0 md:right-[12.5%] md:translate-x-0 min-[425px]:top-[-5%]"
          id="hanging-lamp-2-container"
        >
          <img
            alt="Hanging Lamp"
            className="pointer-events-none relative z-1 aspect-[0.6/1] h-[20dvh] w-auto object-contain md:h-[35dvh] md:w-auto min-[425px]:h-auto min-[425px]:w-[15dvh]"
            height={284}
            src={HangingLamp}
            width={171}
          />
          <svg
            aria-hidden="true"
            className="transform-[translate(-43%,-87%)] sm:transform-[translate(-25%,-70%)] md:transform-[translate(-5%,-45.5%)] absolute top-full left-0 scale-[0.6] animate-blink sm:scale-[0.8] md:scale-[1.3]"
            fill="none"
            focusable="false"
            height="112"
            viewBox="0 0 204 112"
          ...
          <svg
            aria-hidden="true"
            className="transform-[translate(-28%,-18%)] sm:transform-[translate(-27%,-18%)] md:transform-[translate(-18%,-18%)] absolute top-full left-0 scale-[1.2] animate-blink opacity-100 transition-opacity duration-300 ease-linear md:scale-[1.5]"
            fill="none"
            focusable="false"
            height="299"
            viewBox="0 0 394 299"
        ...
        <div
          className="absolute right-1/2 bottom-[10%] flex w-full translate-x-1/2 flex-col items-center justify-center gap-8 px-5 md:right-[5%] md:w-[60%] md:translate-x-0 md:items-end md:justify-end md:gap-16 md:px-0"
          id="content-container"
        >
          <div
            className={"flex flex-col gap-2 text-center md:gap-6 md:text-right"}
            id="text-container"
          >
